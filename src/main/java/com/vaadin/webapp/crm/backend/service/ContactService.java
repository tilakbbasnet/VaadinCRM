package com.vaadin.webapp.crm.backend.service;

import com.vaadin.webapp.crm.backend.entity.Company;
import com.vaadin.webapp.crm.backend.entity.Contact;
import com.vaadin.webapp.crm.backend.repository.CompanyRepository;
import com.vaadin.webapp.crm.backend.repository.ContactRepository;
...
public class ContactService {
    ...
    //Filter condition
    public List<Contact> findAll(String filterValue) {
        if(filterValue == null || "".equals(filterValue)){
            return contactRepository.findAll();
        }
        return contactRepository.search(filterValue);
    }
